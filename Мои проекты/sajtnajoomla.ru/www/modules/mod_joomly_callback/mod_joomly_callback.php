...
if (($fields->captcha !==null ? $fields->captcha : 0)  == 1){
	if ($fields->captcha_size == "invisible"){
		$document->addScript("https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=" . $fields->captcha_sitekey, 'text/javascript', true, true);
	} else {
		$document->addScript("https://www.google.com/recaptcha/api.js?onload=onloadCallbackOld", 'text/javascript', true, true);
	}
}
