    ...
    <content>
     ...
     <div class="frstmedia">     
          <div class="icpicture">
			...
			echo '<p class="lul">Добавить нарушителя в БД</p>
			
			<form class="raspch" action="bd\send2.php" method="post" required> 
				<input type="text" placeholder="Введите id" name="id" required>
				<input type="text"  placeholder="Введите ФИО" name="FIO" required>
				<input type="text" placeholder="Введите Адресс"  name="Adress" required>
				<input type="text" pattern="[А-Я][0-9]{3}[А-Я]{2}" placeholder="Введите Гос. номер" name="GOS" required>
				<input type="text" placeholder="Введите Модель авто" name="Model" required>
				<input type="text" placeholder="Введите Год регистрации" name="GOD" required>
				<input type="text" placeholder="Введите VIN номер" name="VIN" required>
				<input type="text" placeholder="Ссылка на фото нарушения" name="picture" required>
