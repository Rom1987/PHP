...
?>
  <form  action="z14(11).php"  method="post">
	 <!--Поиск-->
	<label for="search"> Введи номер</label> <input name="search" oncheck="color_();" type="text" placeholder="номер" value='<?=$search?>'/> <br> 
    <label for="search1"> Введи тип </label> <input name="search1" type="text" placeholder="тип" value='<?=$search1?>'/> <br>
	<label for="search2"> Введи район </label> <input name="search2" type="date" placeholder="район" value='<?=$search2?>'/> <br>
	<label for="search3"> Введи адрес </label> <input name="search3" type="text" placeholder="адрес" value='<?=$search3?>'/> <br>
    <label for="search4"> Введи часы работы </label> <input name="search4" type="text" placeholder="часы работы" value='<?=$search4?>'/> <br>
